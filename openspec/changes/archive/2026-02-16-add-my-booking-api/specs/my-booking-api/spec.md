...
## Purpose
The system MUST provide a proxy endpoint to retrieve existing booking details from the legacy system, handling authentication and parameter validation automatically while hiding credentials from the frontend.
